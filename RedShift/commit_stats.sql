...
<html lang="en" class=" is-copy-enabled">
  <head prefix="og: http://ogp.me/ns# fb: http://ogp.me/ns/fb# object: http://ogp.me/ns/object# article: http://ogp.me/ns/article# profile: http://ogp.me/ns/profile#">
    ...
    <title>amazon-redshift-utils/commit_stats.sql at master · awslabs/amazon-redshift-utils · GitHub</title>
    ...
    <meta content="collector.githubapp.com" name="octolytics-host" /><meta content="collector-cdn.github.com" name="octolytics-script-host" /><meta content="github" name="octolytics-app-id" /><meta content="40105527:667C:265C176:55B13A48" name="octolytics-dimension-request_id" />
...
<meta content="x5UY3tyoaiHek7aU5C9j7YgjT/0zMO/48JIiUi8T+KzL7veutr/zAJ7WJHIPh7MBmOgholUJvzEAgF3yVdIuZQ==" name="csrf-token" />
  ...
  <div class="container clearfix">
    ...
    <div class="header-actions" role="navigation">
      ...
      <a class="btn" href="/login?return_to=%2Fawslabs%2Famazon-redshift-utils%2Fblob%2Fmaster%2Fsrc%2FAdminScripts%2Fcommit_stats.sql" data-ga-click="(Logged out) Header, clicked Sign in, text:sign-in">Sign in</a>
    </div>
...
<div class="clone-options">You can clone with
  <form accept-charset="UTF-8" action="/users/set_protocol?protocol_selector=http&amp;protocol_type=clone" class="inline-form js-clone-selector-form " data-remote="true" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="0KLt7cPpvpkPj64NXTIgtkNhdDdIYsCKbym4Tt2XP43od7V/iMwgKY/yqog96LhWJbBNw8kOPalTldqhuW53eg==" /></div><button class="btn-link js-clone-selector" data-protocol="http" type="submit">HTTPS</button></form> or <form accept-charset="UTF-8" action="/users/set_protocol?protocol_selector=subversion&amp;protocol_type=clone" class="inline-form js-clone-selector-form " data-remote="true" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="QxdjOaASkmT/lpAWxBbKWK01GeEo4iDVUgE8A4jxXeo62rI/HFaICONsn+uBgX2aFOmXePiTPG0uLfc2iGqBmw==" /></div><button class="btn-link js-clone-selector" data-protocol="subversion" type="submit">Subversion</button></form>.
...
<a href="/awslabs/amazon-redshift-utils/blob/cca356bebd1d8f385ab52cded2fcc608cd0d2fe2/src/AdminScripts/commit_stats.sql" class="hidden js-permalink-shortcut" data-hotkey="y">Permalink</a>

<!-- blob contrib key: blob_contributors:v21:3f663e8bf0b0c472e4ec7d851366add1 -->
      ...
      <div class="select-menu-list select-menu-tab-bucket js-select-menu-tab-bucket" data-tab-filter="branches" role="menu">
        ...
        <div data-filterable-for="context-commitish-filter-field" data-filterable-type="substring">
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open "
               href="/awslabs/amazon-redshift-utils/blob/ericfe-master/src/AdminScripts/commit_stats.sql"
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open selected"
               href="/awslabs/amazon-redshift-utils/blob/master/src/AdminScripts/commit_stats.sql"
               data-name="master"
               data-skip-pjax="true"
               rel="nofollow">
              <span class="select-menu-item-icon octicon octicon-check"></span>
...
<div class="file">
  <div class="file-header">
    <div class="file-actions">
      ...
      <div class="btn-group">
        <a href="/awslabs/amazon-redshift-utils/raw/master/src/AdminScripts/commit_stats.sql" class="btn btn-sm " id="raw-url">Raw</a>
          <a href="/awslabs/amazon-redshift-utils/blame/master/src/AdminScripts/commit_stats.sql" class="btn btn-sm js-update-url-with-hash">Blame</a>
        <a href="/awslabs/amazon-redshift-utils/commits/master/src/AdminScripts/commit_stats.sql" class="btn btn-sm " rel="nofollow">History</a>
      </div>
  ...
  <div class="blob-wrapper data type-sql">
      ...
      <tr>
        ...
        <td id="LC2" class="blob-code blob-code-inner js-file-line"><span class="pl-c">Purpose: Return commit queue statistics from past 2 days, showing largest queue length and queue time first</span></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC5" class="blob-code blob-code-inner js-file-line"><span class="pl-c">startqueue:		Time when the queueing started</span></td>
      </tr>
      <tr>
        <td id="L6" class="blob-num js-line-number" data-line-number="6"></td>
        <td id="LC6" class="blob-code blob-code-inner js-file-line"><span class="pl-c">node:			Node where the queue started. Usually -1 (leader). A number between 0 and # nodes might indicate a issue with a node</span></td>
      </tr>
      <tr>
        <td id="L7" class="blob-num js-line-number" data-line-number="7"></td>
        <td id="LC7" class="blob-code blob-code-inner js-file-line"><span class="pl-c">queue_time:		Queue time in miliseconds</span></td>
      </tr>
      <tr>
        <td id="L8" class="blob-num js-line-number" data-line-number="8"></td>
        <td id="LC8" class="blob-code blob-code-inner js-file-line"><span class="pl-c">commit_time:		Commit time in miliseconds</span></td>
      </tr>
      <tr>
        <td id="L9" class="blob-num js-line-number" data-line-number="9"></td>
        <td id="LC9" class="blob-code blob-code-inner js-file-line"><span class="pl-c">queuelen:		Number of transactions in the queue</span></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC13" class="blob-code blob-code-inner js-file-line"><span class="pl-c">History:</span></td>
      </tr>
      <tr>
        <td id="L14" class="blob-num js-line-number" data-line-number="14"></td>
        <td id="LC14" class="blob-code blob-code-inner js-file-line"><span class="pl-c">2015-02-09 ericfe created</span></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC16" class="blob-code blob-code-inner js-file-line"><span class="pl-k">select</span> startqueue,node, datediff(ms,startqueue,startwork) <span class="pl-k">as</span> queue_time, datediff(ms, startwork, endtime) <span class="pl-k">as</span> commit_time, queuelen </td>
      </tr>
      <tr>
        <td id="L17" class="blob-num js-line-number" data-line-number="17"></td>
        <td id="LC17" class="blob-code blob-code-inner js-file-line"><span class="pl-k">from</span> stl_commit_stats </td>
      </tr>
      <tr>
        <td id="L18" class="blob-num js-line-number" data-line-number="18"></td>
        <td id="LC18" class="blob-code blob-code-inner js-file-line"><span class="pl-k">where</span> startqueue <span class="pl-k">&gt;=</span>  dateadd(day, <span class="pl-k">-</span><span class="pl-c1">2</span>, <span class="pl-c1">current_Date</span>)</td>
      </tr>
      <tr>
        <td id="L19" class="blob-num js-line-number" data-line-number="19"></td>
        <td id="LC19" class="blob-code blob-code-inner js-file-line"><span class="pl-k">order by</span> queuelen <span class="pl-k">desc</span> , queue_time <span class="pl-k">desc</span>;</td>
      </tr>
</table>
...
<div id="jump-to-line" style="display:none">
  ...
  <div class="site-footer" role="contentinfo">
    ...
    <ul class="site-footer-links">
      <li>&copy; 2015 <span title="0.03222s from github-fe137-cp1-prd.iad.github.net">GitHub</span>, Inc.</li>
