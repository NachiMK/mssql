...
<html lang="en" class=" is-copy-enabled">
  <head prefix="og: http://ogp.me/ns# fb: http://ogp.me/ns/fb# object: http://ogp.me/ns/object# article: http://ogp.me/ns/article# profile: http://ogp.me/ns/profile#">
    ...
    <title>amazon-redshift-utils/current_session_info.sql at master · awslabs/amazon-redshift-utils · GitHub</title>
    ...
    <meta content="collector.githubapp.com" name="octolytics-host" /><meta content="collector-cdn.github.com" name="octolytics-script-host" /><meta content="github" name="octolytics-app-id" /><meta content="40105527:692A:4C0FA5:55B13A58" name="octolytics-dimension-request_id" />
...
<meta content="jR+axi9cC5o+ZH8XGcLsiaL3OzRD/lQKyX8WZLb8bOImPJQfGk524QFlwQWfWVABwEOdNtFOGn4nQZaCzlQD7g==" name="csrf-token" />
  ...
  <div class="container clearfix">
    ...
    <div class="header-actions" role="navigation">
      ...
      <a class="btn" href="/login?return_to=%2Fawslabs%2Famazon-redshift-utils%2Fblob%2Fmaster%2Fsrc%2FAdminScripts%2Fcurrent_session_info.sql" data-ga-click="(Logged out) Header, clicked Sign in, text:sign-in">Sign in</a>
    </div>
...
<div class="clone-options">You can clone with
  <form accept-charset="UTF-8" action="/users/set_protocol?protocol_selector=http&amp;protocol_type=clone" class="inline-form js-clone-selector-form " data-remote="true" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="Q+QU3+kVkPPJHVRGGf6Va0rI7mAOVoz9M0cVGFRAVYKn7XCF5Ls6LVKIuzCOBmSMx/UZA/dPAHo5DeIVJnKF/w==" /></div><button class="btn-link js-clone-selector" data-protocol="http" type="submit">HTTPS</button></form> or <form accept-charset="UTF-8" action="/users/set_protocol?protocol_selector=subversion&amp;protocol_type=clone" class="inline-form js-clone-selector-form " data-remote="true" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="ECd/WnAlw1T8ns4aZlTgof9BXsbBWcKDFcowhJLnEVRJXMKLrJGmCo/WmShOfq9IKcvrLTFILqpHY+4x/Uz0mQ==" /></div><button class="btn-link js-clone-selector" data-protocol="subversion" type="submit">Subversion</button></form>.
...
<a href="/awslabs/amazon-redshift-utils/blob/cca356bebd1d8f385ab52cded2fcc608cd0d2fe2/src/AdminScripts/current_session_info.sql" class="hidden js-permalink-shortcut" data-hotkey="y">Permalink</a>

<!-- blob contrib key: blob_contributors:v21:653892f0148737bf5fee1db12ee4b714 -->
      ...
      <div class="select-menu-list select-menu-tab-bucket js-select-menu-tab-bucket" data-tab-filter="branches" role="menu">
        ...
        <div data-filterable-for="context-commitish-filter-field" data-filterable-type="substring">
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open "
               href="/awslabs/amazon-redshift-utils/blob/ericfe-master/src/AdminScripts/current_session_info.sql"
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open selected"
               href="/awslabs/amazon-redshift-utils/blob/master/src/AdminScripts/current_session_info.sql"
               data-name="master"
               data-skip-pjax="true"
               rel="nofollow">
              <span class="select-menu-item-icon octicon octicon-check"></span>
...
<div class="file">
  <div class="file-header">
    <div class="file-actions">
      ...
      <div class="btn-group">
        <a href="/awslabs/amazon-redshift-utils/raw/master/src/AdminScripts/current_session_info.sql" class="btn btn-sm " id="raw-url">Raw</a>
          <a href="/awslabs/amazon-redshift-utils/blame/master/src/AdminScripts/current_session_info.sql" class="btn btn-sm js-update-url-with-hash">Blame</a>
        <a href="/awslabs/amazon-redshift-utils/commits/master/src/AdminScripts/current_session_info.sql" class="btn btn-sm " rel="nofollow">History</a>
      </div>
  ...
  <div class="blob-wrapper data type-sql">
      ...
      <tr>
        ...
        <td id="LC1" class="blob-code blob-code-inner js-file-line"><span class="pl-c">/* Query showing information about sessions with currently running queries */</span></td>
      </tr>
      <tr>
        <td id="L2" class="blob-num js-line-number" data-line-number="2"></td>
        <td id="LC2" class="blob-code blob-code-inner js-file-line"><span class="pl-k">SELECT</span> <span class="pl-c1">s</span>.<span class="pl-c1">process</span> <span class="pl-k">AS</span> pid</td>
      </tr>
      <tr>
        <td id="L3" class="blob-num js-line-number" data-line-number="3"></td>
        <td id="LC3" class="blob-code blob-code-inner js-file-line">       ,date_Trunc (<span class="pl-s"><span class="pl-pds">&#39;</span>second<span class="pl-pds">&#39;</span></span>,<span class="pl-c1">s</span>.<span class="pl-c1">starttime</span>) <span class="pl-k">AS</span> S_START</td>
      </tr>
      <tr>
        <td id="L4" class="blob-num js-line-number" data-line-number="4"></td>
        <td id="LC4" class="blob-code blob-code-inner js-file-line">       ,datediff(minutes,<span class="pl-c1">s</span>.<span class="pl-c1">starttime</span>,getdate ()) <span class="pl-k">AS</span> conn_mins</td>
      </tr>
      <tr>
        <td id="L5" class="blob-num js-line-number" data-line-number="5"></td>
        <td id="LC5" class="blob-code blob-code-inner js-file-line">       ,<span class="pl-c1">trim</span>(<span class="pl-c1">s</span>.<span class="pl-c1">user_name</span>) <span class="pl-k">AS</span> USER</td>
      </tr>
      <tr>
        <td id="L6" class="blob-num js-line-number" data-line-number="6"></td>
        <td id="LC6" class="blob-code blob-code-inner js-file-line">       ,<span class="pl-c1">trim</span>(<span class="pl-c1">s</span>.<span class="pl-c1">db_name</span>) <span class="pl-k">AS</span> DB</td>
      </tr>
      <tr>
        <td id="L7" class="blob-num js-line-number" data-line-number="7"></td>
        <td id="LC7" class="blob-code blob-code-inner js-file-line">       ,date_trunc (<span class="pl-s"><span class="pl-pds">&#39;</span>second<span class="pl-pds">&#39;</span></span>,<span class="pl-c1">i</span>.<span class="pl-c1">starttime</span>) <span class="pl-k">AS</span> Q_START</td>
      </tr>
      <tr>
        <td id="L8" class="blob-num js-line-number" data-line-number="8"></td>
        <td id="LC8" class="blob-code blob-code-inner js-file-line">       ,<span class="pl-c1">i</span>.<span class="pl-c1">query</span></td>
      </tr>
      <tr>
        <td id="L9" class="blob-num js-line-number" data-line-number="9"></td>
        <td id="LC9" class="blob-code blob-code-inner js-file-line">       ,<span class="pl-c1">trim</span>(<span class="pl-c1">i</span>.<span class="pl-c1">query</span>) <span class="pl-k">AS</span> sql</td>
      </tr>
      <tr>
        <td id="L10" class="blob-num js-line-number" data-line-number="10"></td>
        <td id="LC10" class="blob-code blob-code-inner js-file-line"><span class="pl-k">FROM</span> stv_sessions s</td>
      </tr>
      <tr>
        <td id="L11" class="blob-num js-line-number" data-line-number="11"></td>
        <td id="LC11" class="blob-code blob-code-inner js-file-line">  <span class="pl-k">LEFT JOIN</span> stv_recents i</td>
      </tr>
      <tr>
        <td id="L12" class="blob-num js-line-number" data-line-number="12"></td>
        <td id="LC12" class="blob-code blob-code-inner js-file-line">         <span class="pl-k">ON</span> <span class="pl-c1">s</span>.<span class="pl-c1">process</span> <span class="pl-k">=</span> <span class="pl-c1">i</span>.<span class="pl-c1">pid</span></td>
      </tr>
      <tr>
        <td id="L13" class="blob-num js-line-number" data-line-number="13"></td>
        <td id="LC13" class="blob-code blob-code-inner js-file-line">        <span class="pl-k">AND</span> <span class="pl-c1">i</span>.<span class="pl-c1">status</span> <span class="pl-k">=</span> <span class="pl-s"><span class="pl-pds">&#39;</span>Running<span class="pl-pds">&#39;</span></span></td>
      </tr>
      <tr>
        <td id="L14" class="blob-num js-line-number" data-line-number="14"></td>
        <td id="LC14" class="blob-code blob-code-inner js-file-line"><span class="pl-k">WHERE</span> <span class="pl-c1">s</span>.<span class="pl-c1">user_name</span> <span class="pl-k">&lt;&gt;</span> <span class="pl-s"><span class="pl-pds">&#39;</span>rdsdb<span class="pl-pds">&#39;</span></span></td>
      </tr>
      <tr>
        <td id="L15" class="blob-num js-line-number" data-line-number="15"></td>
        <td id="LC15" class="blob-code blob-code-inner js-file-line"><span class="pl-k">ORDER BY</span> <span class="pl-c1">1</span></td>
      </tr>
</table>
...
<div id="jump-to-line" style="display:none">
  ...
  <div class="site-footer" role="contentinfo">
    ...
    <ul class="site-footer-links">
      <li>&copy; 2015 <span title="0.03667s from github-fe121-cp1-prd.iad.github.net">GitHub</span>, Inc.</li>
