...
<html lang="en" class=" is-copy-enabled">
  <head prefix="og: http://ogp.me/ns# fb: http://ogp.me/ns/fb# object: http://ogp.me/ns/object# article: http://ogp.me/ns/article# profile: http://ogp.me/ns/profile#">
    ...
    <title>amazon-redshift-utils/missing_table_stats.sql at master · awslabs/amazon-redshift-utils · GitHub</title>
    ...
    <meta content="collector.githubapp.com" name="octolytics-host" /><meta content="collector-cdn.github.com" name="octolytics-script-host" /><meta content="github" name="octolytics-app-id" /><meta content="40105527:692A:4C10D1:55B13A5D" name="octolytics-dimension-request_id" />
...
<meta content="AVfSFRKZ+1LPC9sR1QIGeYO0z9EcwSDJN7gdOMW1BXb6naslidoh5gsFlwyNkcDR6eP3ssFe39zMa9foC/Ib/w==" name="csrf-token" />
  ...
  <div class="container clearfix">
    ...
    <div class="header-actions" role="navigation">
      ...
      <a class="btn" href="/login?return_to=%2Fawslabs%2Famazon-redshift-utils%2Fblob%2Fmaster%2Fsrc%2FAdminScripts%2Fmissing_table_stats.sql" data-ga-click="(Logged out) Header, clicked Sign in, text:sign-in">Sign in</a>
    </div>
...
<div class="clone-options">You can clone with
  <form accept-charset="UTF-8" action="/users/set_protocol?protocol_selector=http&amp;protocol_type=clone" class="inline-form js-clone-selector-form " data-remote="true" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="+8GlYQCbS9j5mK8XJ997VaOGfYZVDliJdHRLHkDCw3n53ad79xIeQuoyGfs/jvp9MCc8ceGiJCoygeTU11UlWw==" /></div><button class="btn-link js-clone-selector" data-protocol="http" type="submit">HTTPS</button></form> or <form accept-charset="UTF-8" action="/users/set_protocol?protocol_selector=subversion&amp;protocol_type=clone" class="inline-form js-clone-selector-form " data-remote="true" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="Nzfz1igBFRFkC/c5m7Z9SKflaaxOA707jhaufbiaq1B7CGi+uKZtmM5c7fLSMDrHtIpIzC7uGUV4mokApWZJJw==" /></div><button class="btn-link js-clone-selector" data-protocol="subversion" type="submit">Subversion</button></form>.
...
<a href="/awslabs/amazon-redshift-utils/blob/cca356bebd1d8f385ab52cded2fcc608cd0d2fe2/src/AdminScripts/missing_table_stats.sql" class="hidden js-permalink-shortcut" data-hotkey="y">Permalink</a>

<!-- blob contrib key: blob_contributors:v21:be45ca49e5bda7e60285b3c28833d90c -->
...
<div class="select-menu js-menu-container js-select-menu left">
      ...
      <div class="select-menu-list select-menu-tab-bucket js-select-menu-tab-bucket" data-tab-filter="branches" role="menu">
        ...
        <div data-filterable-for="context-commitish-filter-field" data-filterable-type="substring">
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open "
               href="/awslabs/amazon-redshift-utils/blob/ericfe-master/src/AdminScripts/missing_table_stats.sql"
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open selected"
               href="/awslabs/amazon-redshift-utils/blob/master/src/AdminScripts/missing_table_stats.sql"
               data-name="master"
               data-skip-pjax="true"
               rel="nofollow">
              <span class="select-menu-item-icon octicon octicon-check"></span>
  ...
  <div class="commit file-history-tease">
    <div class="file-history-tease-header">
        <img alt="@tpcstld" class="avatar" height="24" src="https://avatars3.githubusercontent.com/u/5456182?v=3&amp;s=48" width="24" />
        <span class="author"><a href="/tpcstld" rel="contributor">tpcstld</a></span>
        <time datetime="2015-04-08T00:21:42Z" is="relative-time">Apr 7, 2015</time>
        <div class="commit-title">
            <a href="/awslabs/amazon-redshift-utils/commit/c193e107d7a2dc8a5f27fa9ddeae694c0f854a8c" class="message" data-pjax="true" title="More grammar changes

Capitalized &quot;explain&quot;, put &quot;the&quot; between &quot;on&quot; and &quot;underlying&quot;">More grammar changes</a>
        </div>
    </div>
    ...
    <div class="participation">
      <p class="quickstat">
        <a href="#blob_contributors_box" rel="facebox">
          ...
          <a class="avatar-link tooltipped tooltipped-s" aria-label="tpcstld" href="/awslabs/amazon-redshift-utils/commits/master/src/AdminScripts/missing_table_stats.sql?author=tpcstld"><img alt="@tpcstld" class="avatar" height="20" src="https://avatars1.githubusercontent.com/u/5456182?v=3&amp;s=40" width="20" /> </a>
    <a class="avatar-link tooltipped tooltipped-s" aria-label="IanMeyers" href="/awslabs/amazon-redshift-utils/commits/master/src/AdminScripts/missing_table_stats.sql?author=IanMeyers"><img alt="@IanMeyers" class="avatar" height="20" src="https://avatars3.githubusercontent.com/u/6339696?v=3&amp;s=40" width="20" /> </a>
    ...
    <div id="blob_contributors_box" style="display:none">
      ...
      <ul class="facebox-user-list">
          <li class="facebox-user-list-item">
            <img alt="@tpcstld" height="24" src="https://avatars3.githubusercontent.com/u/5456182?v=3&amp;s=48" width="24" />
            <a href="/tpcstld">tpcstld</a>
          </li>
          <li class="facebox-user-list-item">
...
<div class="file">
  <div class="file-header">
    <div class="file-actions">
      ...
      <div class="btn-group">
        <a href="/awslabs/amazon-redshift-utils/raw/master/src/AdminScripts/missing_table_stats.sql" class="btn btn-sm " id="raw-url">Raw</a>
          <a href="/awslabs/amazon-redshift-utils/blame/master/src/AdminScripts/missing_table_stats.sql" class="btn btn-sm js-update-url-with-hash">Blame</a>
        <a href="/awslabs/amazon-redshift-utils/commits/master/src/AdminScripts/missing_table_stats.sql" class="btn btn-sm " rel="nofollow">History</a>
      </div>
  ...
  <div class="blob-wrapper data type-sql">
      ...
      <tr>
        ...
        <td id="LC1" class="blob-code blob-code-inner js-file-line"><span class="pl-c">/* Query shows EXPLAIN plans which flagged &quot;missing statistics&quot; on the underlying tables */</span></td>
      </tr>
      <tr>
        <td id="L2" class="blob-num js-line-number" data-line-number="2"></td>
        <td id="LC2" class="blob-code blob-code-inner js-file-line"><span class="pl-k">SELECT</span> <span class="pl-c1">substring</span>(<span class="pl-c1">trim</span>(plannode),<span class="pl-c1">1</span>,<span class="pl-c1">100</span>) <span class="pl-k">AS</span> plannode</td>
      </tr>
      <tr>
        <td id="L3" class="blob-num js-line-number" data-line-number="3"></td>
        <td id="LC3" class="blob-code blob-code-inner js-file-line">       ,<span class="pl-c1">COUNT</span>(<span class="pl-k">*</span>)</td>
      </tr>
      <tr>
        <td id="L4" class="blob-num js-line-number" data-line-number="4"></td>
        <td id="LC4" class="blob-code blob-code-inner js-file-line"><span class="pl-k">FROM</span> stl_explain</td>
      </tr>
      <tr>
        <td id="L5" class="blob-num js-line-number" data-line-number="5"></td>
        <td id="LC5" class="blob-code blob-code-inner js-file-line"><span class="pl-k">WHERE</span> plannode <span class="pl-k">LIKE</span> <span class="pl-s"><span class="pl-pds">&#39;</span>%missing statistics%<span class="pl-pds">&#39;</span></span></td>
      </tr>
      <tr>
        <td id="L6" class="blob-num js-line-number" data-line-number="6"></td>
        <td id="LC6" class="blob-code blob-code-inner js-file-line"><span class="pl-k">GROUP BY</span> plannode</td>
      </tr>
      <tr>
        <td id="L7" class="blob-num js-line-number" data-line-number="7"></td>
        <td id="LC7" class="blob-code blob-code-inner js-file-line"><span class="pl-k">ORDER BY</span> <span class="pl-c1">2</span> <span class="pl-k">DESC</span>;</td>
      </tr>
</table>
...
<div id="jump-to-line" style="display:none">
  ...
  <div class="site-footer" role="contentinfo">
    ...
    <ul class="site-footer-links">
      <li>&copy; 2015 <span title="0.09762s from github-fe124-cp1-prd.iad.github.net">GitHub</span>, Inc.</li>
